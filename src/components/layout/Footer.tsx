    ...
    <footer className="bg-secondary py-12 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">Code Tribe</h3>
            <p className="text-muted-foreground mb-4">
              Finding the perfect hackathon teammates has never been easier.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/hackathons" className="text-muted-foreground hover:text-primary transition-colors">Hackathons</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Hackathon Guide</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Team Building Tips</a></li>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Code Tribe. All rights reserved.</p>
          <p>Made with ❤️ for hackathon enthusiasts worldwide</p>
        </div>
      </div>
    </footer>
  );
